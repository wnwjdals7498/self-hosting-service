...
## fork-custom: header-PAT factory 전용 tool 세트 (files + admin)
def register_fork_tools(mcp: FastMCP) -> None:
    """Register fork-only tools. Called from get_header_mcp() only."""
    from plane_mcp.tools.admin import register_admin_tools
    from plane_mcp.tools.files import register_files_tools
