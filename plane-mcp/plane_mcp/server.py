...
from plane_mcp.tools import register_fork_tools, register_tools
...
def get_header_mcp():
    ...
    ## fork-custom: expose files + admin tools on header-PAT transport only
    register_fork_tools(header_mcp)
    return header_mcp
