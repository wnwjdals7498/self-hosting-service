...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        # Phase 4.3: LocalFSStorage has no bucket concept — skip cleanly so
        # operators running the full upstream bootstrap sequence under
        # USE_LOCAL_STORAGE=1 don't hit a long S3 timeout against a
