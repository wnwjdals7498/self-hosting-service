...
urlpatterns = [
    ...
    # fork-custom: on-demand PlaneBackup trigger (plane-mcp-v2-deploy)
    path("admin/backup/", AdminBackupView.as_view(), name="instance-admin-backup"),
]
