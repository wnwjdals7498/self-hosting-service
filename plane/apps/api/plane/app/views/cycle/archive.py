...
from plane.db.models import Cycle, IssueAssignee, UserFavorite, Issue, Label, User, Project
                ...
                assignee_ids=Coalesce(
                    Subquery(
                        IssueAssignee.objects.filter(
                            issue__issue_cycle__cycle_id=OuterRef("pk"),
                            issue__issue_cycle__deleted_at__isnull=True,
                            deleted_at__isnull=True,
                            assignee_id__isnull=False,
                        )
                        .values("issue__issue_cycle__cycle_id")
