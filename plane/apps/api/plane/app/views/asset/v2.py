...
# fork-custom: plane-mcp-server calls ProjectAssetEndpoint with X-Api-Key
# (plane-mcp-v2-deploy N4 smoke). BaseSessionAuthentication alone would
# reject PAT-authenticated requests with 401.
