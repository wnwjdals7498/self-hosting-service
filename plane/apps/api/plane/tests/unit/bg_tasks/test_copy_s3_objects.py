...
class TestCopyS3Objects:
    ...
    def test_copy_s3_objects_of_description_and_assets(
        self, mock_get_storage, create_user, workspace, project, issue, file_asset
    ):
    ...
    @pytest.mark.django_db
    @patch("plane.bgtasks.copy_s3_object.get_storage")
    def test_copy_assets_successful(self, mock_get_storage, workspace, project, issue, file_asset):
    ...
    @pytest.mark.django_db
    @patch("plane.bgtasks.copy_s3_object.get_storage")
    def test_copy_assets_empty_asset_ids(self, mock_get_storage, workspace, project, issue):
    ...
    @pytest.mark.django_db
    @patch("plane.bgtasks.copy_s3_object.get_storage")
    def test_copy_assets_nonexistent_asset(self, mock_get_storage, workspace, project, issue):
